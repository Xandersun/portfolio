    ...
    <div style={{ padding: 32, maxWidth: 1100, marginInline: "auto" }}>
      ...
      <Card style={{ marginBottom: 40 }}>
        <Title level={1} style={{ marginTop: 0 }}>
          Heading 1 — Acquisition Intelligence
        </Title>
        <Title level={2}>Heading 2 — Program Risk Overview</Title>
        ...
        <Paragraph>
          Body paragraph text. Fused sources are cross-referenced against structured and
          unstructured reporting to produce a defensible confidence score for every tracked
          program.
        </Paragraph>
      ...
      >
        ...
        <Card
          ...
          extra={<Tag color="success">Low Risk</Tag>}
        >
          <Paragraph style={{ marginBottom: 0 }}>
