...
/**
 * portfolio-v2 / Living Design System — Keyboard Shortcuts.
 * Content-only isolated copy of
 * app/(defense-app)/sandbox/keyboard-shortcuts/page.tsx (untouched, still
 * serves the original /sandbox): identical structure, backed by
 * lib/portfolio-v2/actions.tsx instead of lib/sandbox-actions.tsx.
 */
...
import { ACTIONS, CATEGORY_ORDER, getActionById, isMacPlatform } from "@/lib/portfolio-v2/actions";
...
const GLOBAL_BINDINGS: GlobalBinding[] = [
  ...
  {
    keys: ["Alt N"],
    description: "Run “New Case Intake” directly, no palette needed",
    scope: "Suite-wide",
  ...
  return (
    <div style={{ padding: 32, maxWidth: 980, marginInline: "auto" }}>
      ...
      <Paragraph type="secondary" style={{ marginBottom: 32 }}>
        Every shortcut available across the Living Design System. &ldquo;Suite-wide&rdquo;
        bindings work from any LDS page right now — try pressing <Text keyboard>{shortcutLabel}</Text>{" "}
        while reading this. Click <Text keyboard>Trigger</Text> on any row to fire it without
