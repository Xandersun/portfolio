...
/**
 * portfolio-v2 / Living Design System — Command Palette.
 * Content-only isolated copy of
 * app/(defense-app)/sandbox/command-palette/page.tsx (untouched, still
 * serves the original /sandbox): identical structure, backed by
 * lib/portfolio-v2/actions.tsx (case-management action labels routed to
 * /portfolio-v2/lds/*) instead of lib/sandbox-actions.tsx.
 */
...
import { ACTIONS, CATEGORY_ORDER, isMacPlatform } from "@/lib/portfolio-v2/actions";
  ...
  return (
    <div style={{ padding: 32, maxWidth: 900, marginInline: "auto" }}>
      ...
      <Paragraph type="secondary" style={{ marginBottom: 32 }}>
        ...
        <strong>any</strong> Living Design System page to open the palette — it&apos;s mounted once
        at the LDS shell level. Use <Text keyboard>↑</Text> <Text keyboard>↓</Text> to move,{" "}
        <Text keyboard>Enter</Text> to run, <Text keyboard>Esc</Text> to close. See{" "}
        <Text code>/portfolio-v2/lds/keyboard-shortcuts</Text> for the full reference.
      </Paragraph>
