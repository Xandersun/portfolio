...
/**
 * portfolio-v2 / Living Design System — Design System.
 * Content-only isolated copy of
 * app/(defense-app)/sandbox/design-system/page.tsx (untouched, still
 * serves the original /sandbox): identical structure throughout — only the
 * few lines of domain-flavored demo copy in the typography block changed
 * from defense-acquisition language to case-management language.
 */
  ...
  return (
    <div style={{ padding: 32, maxWidth: 1100, marginInline: "auto" }}>
      ...
      <Alert
        ...
        description="Changing the theme token object in components/layout/app-shell.tsx updates every swatch and component on this page automatically."
      />
    </div>
  );
}
